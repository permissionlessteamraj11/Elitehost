    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020108] px-4 py-12">
      ...
      >
        ...
        <div className="p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl">
          {freePlanEnabled && (
            <div className="mb-6 p-3 rounded-xl bg-[#FFFFFF]/10 border border-[#FFFFFF]/20 flex items-center gap-3">
              <Gift className="w-5 h-5 text-[#FFFFFF]" />
              <span className="text-sm font-medium text-[#FFFFFF]">2 free credits — no card required</span>
            </div>
          )}
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="johndoe"
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#FFFFFF]/50 transition-all font-mono"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#FFFFFF]/50 transition-all font-mono uppercase"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 bg-[#FFFFFF] text-black rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(0,229,255,0.3)] ${
                loading ? "opacity-50 cursor-not-allowed" : "hover:scale-[1.02] active:scale-[0.98] hover:bg-[#FFFFFF]/90"
              }`}
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 text-sm">
              ...
              <Link href="/auth/login" className="text-white font-semibold hover:text-[#FFFFFF] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
