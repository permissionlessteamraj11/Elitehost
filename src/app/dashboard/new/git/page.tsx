...
import { Github, ArrowRight, Loader2, Plus, X, ChevronLeft } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div className="space-y-2">
        ...
        <p className="text-white/40">Connect your repository and deploy in seconds.</p>
      </div>
      ...
      <GlassCard className="p-8 space-y-8" hover={false} glow>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-text-secondary uppercase tracking-widest small-caps">Repository URL</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-void/50 border border-white/10 rounded-sm pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-electric/50"
              />
            </div>
          </div>
        </div>
