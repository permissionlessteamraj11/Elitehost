        ...
        <div className="flex-1">
          {activeTab === "account" && (
            <GlassCard className="p-8 space-y-8" hover={false}>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                     <label htmlFor="referral_code" className="text-xs font-bold text-text-secondary uppercase tracking-widest">Referral Code</label>
            ...
            <div className="space-y-6">
              ...
              <GlassCard className="p-8 space-y-6" hover={false}>
                ...
                <form onSubmit={handleWithdraw} className="space-y-4 max-w-md">
                   <div className="space-y-2">
                     <label htmlFor="withdrawAmount" className="text-xs font-bold text-text-secondary uppercase tracking-widest small-caps">Withdraw Amount</label>
                     <input
                       id="withdrawAmount"
                       type="number"
                       required
                   ...
                   <div className="space-y-2">
                     <label htmlFor="upiId" className="text-xs font-bold text-text-secondary uppercase tracking-widest small-caps">UPI ID / Payment Details</label>
                     <input
                       id="upiId"
                       type="text"
                       required
                   ...
                   {withdrawSuccess && (
                     <div className="p-3 rounded-lg bg-emerald-500/10 text-emerald-500 text-[10px] font-bold uppercase flex items-center gap-2">
          ...
          {activeTab === "security" && (
             <div className="space-y-6">
                <GlassCard className="p-8 space-y-6" hover={false}>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="currentPwd" className="text-xs font-bold text-text-secondary uppercase tracking-widest small-caps">Current Password</label>
                        <input
                          id="currentPwd"
                          type="password"
                          value={currentPwd}
                      ...
                      <div className="space-y-2">
                        <label htmlFor="newPwd" className="text-xs font-bold text-text-secondary uppercase tracking-widest">New Password</label>
                        <input
                          id="newPwd"
                          type="password"
                          value={newPwd}
          ...
          {activeTab === "notifications" && (
            <GlassCard className="p-8 space-y-8" hover={false}>
              ...
              <div className="space-y-4">
                {[
                  { id: "deploymentSuccess", label: "Deployment Success", desc: "Notify when a build is successful." },
                  { id: "deploymentFailure", label: "Deployment Failure", desc: "Urgent alerts for failed builds." },
                  { id: "usageAlerts", label: "Usage Alerts", desc: "Notify when approaching plan limits." },
                  { id: "securityAlerts", label: "Security Alerts", desc: "Notifications about account security." }
                ].map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-4 rounded-xl border border-white/5">
                    ...
                    <button
                      ...
                      className={cn(
                        "w-10 h-5 rounded-full relative cursor-pointer border transition-all focus-ring",
