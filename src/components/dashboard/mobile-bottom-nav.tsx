            ...
            if (item.center) {
              return (
                <Link key={item.href} href={item.href} className="relative group">
                  <div className="w-12 h-12 rounded-2xl bg-primary text-background flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-transform active:scale-90">
