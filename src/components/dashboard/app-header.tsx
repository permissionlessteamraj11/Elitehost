    ...
    <header className="sticky top-0 z-40 w-full px-4 pt-4 pb-2 lg:px-8 lg:pt-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between glass-morphism rounded-[24px] p-2 pr-3 pl-4 border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <motion.button
            whileTap={{ scale: 0.9 }}
            className="p-2 text-white/50 hover:text-white transition-colors focus-ring rounded-lg"
            aria-label="Search"
          >
          ...
          <motion.button
            whileTap={{ scale: 0.9 }}
            className="p-2 text-white/50 hover:text-white transition-colors relative focus-ring rounded-lg"
